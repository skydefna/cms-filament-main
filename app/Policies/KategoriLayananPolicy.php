...
class KategoriLayananPolicy
{
    ...
    {
        return $user->can('view_any_kategori::pelayanan');
    }
    ...
    {
        return $user->can('view_kategori::pelayanan');
    }
    ...
    {
        return $user->can('create_kategori::pelayanan');
    }
    ...
    {
        return $user->can('update_kategori::pelayanan');
    }
    ...
    {
        return $user->can('delete_kategori::pelayanan');
    }
    ...
    {
        return $user->can('delete_any_kategori::pelayanan');
    }
    ...
    {
        return $user->can('reorder_kategori::pelayanan');
    }
}
