...
class YoutubeVideoPolicy
{
    ...
    {
        return $user->can('view_any_youtube::video');
    }
    ...
    {
        return $user->can('view_youtube::video');
    }
    ...
    {
        return $user->can('create_youtube::video');
    }
    ...
    {
        return $user->can('update_youtube::video');
    }
    ...
    {
        return $user->can('delete_youtube::video');
    }
    ...
    {
        return $user->can('delete_any_youtube::video');
    }
     ...
     */
    public function replicate(User $user, YoutubeVideo $youtubeVideo): bool
    {
    ...
    {
        return $user->can('reorder_youtube::video');
    }
}
