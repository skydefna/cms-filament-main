...
class SuratPermohonanPolicy
{
    ...
    {
        return $user->can('view_any_surat::permohonan');
    }
    ...
    {
        return $user->can('view_surat::permohonan');
    }
    ...
    {
        return $user->can('create_surat::permohonan');
    }
    ...
    {
        return $user->can('update_surat::permohonan');
    }
    ...
    {
        return $user->can('delete_surat::permohonan');
    }
    ...
    {
        return $user->can('delete_any_surat::permohonan');
    }
     ...
     */
    public function replicate(User $user, SuratPermohonan $suratPermohonan): bool
    {
    ...
    {
        return $user->can('reorder_surat::permohonan');
    }
}
